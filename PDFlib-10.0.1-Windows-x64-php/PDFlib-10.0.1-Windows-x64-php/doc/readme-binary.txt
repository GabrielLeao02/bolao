...
- Static 32-bit/64-bit libraries for C/C++ are available upon request.

The 32-bit Windows libraries are not compatible with Embarcadero C++ Builder.
See system-requirements.txt for instructions regarding the use of the 64-bit
Windows libraries with Embarcadero C++ Builder.
